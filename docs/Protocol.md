...
A document's hash is the cryptographic hash derived from the blockchain's hasing primitive
(SHA256 for Bitcoin). A document's address is the blockchain address determinstically derived
